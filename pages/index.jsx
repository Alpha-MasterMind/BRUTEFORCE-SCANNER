...
export default function Scanner() {
    ...
    return (
      <div className="fixed inset-0 bg-black z-50 flex items-center justify-center font-mono">
        ...
        <div className="relative z-10 text-center px-4 py-8 max-w-md w-full">
          ...
          <div className="text-cyan-500/40 text-xs sm:text-sm tracking-widest">BruteforceScannerR</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className="min-h-screen text-white font-mono text-sm relative scan-lines bg-grid" style={{ backgroundImage: "url('/background.png')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
